                ...
                <div className="bg-[#1e2235] border border-white/10 rounded-2xl shadow-xl overflow-hidden">
                    <form onSubmit={handleSubmit} className="p-8">
                        ...
                        <div className="bg-white/5 border border-white/10 rounded-xl p-6 mb-8">
                            <h3 className="text-lg font-semibold mb-6 flex items-center gap-2 border-b border-white/10 pb-3 text-teal-400">
                                ...
                                <div>
                                    ...
                                    <div className="relative">
                                        <select
                                            ...
                                            className="w-full bg-white/5 border border-white/10 rounded-lg py-3 pl-4 pr-12 text-white focus:border-teal-400 focus:outline-none appearance-none"
                                            required
                                        >
                                        ...
                                        <button
                                            ...
                                            className="absolute right-0 top-0 bottom-0 px-4 bg-teal-500/10 hover:bg-teal-500/20 text-teal-400 rounded-r-lg border-l border-white/10"
                                        >
                        ...
                        <div className="bg-white/5 border border-white/10 rounded-xl p-6 mb-8">
                            <div className="flex justify-between items-center mb-6 border-b border-white/10 pb-3">
                                <h3 className="text-lg font-semibold flex items-center gap-2 text-teal-400">
                                ...
                                <button
                                    ...
                                    className="px-4 py-2 bg-teal-600 text-white font-semibold rounded-lg hover:bg-teal-700 transition-all flex items-center gap-2"
                                >
                        ...
                        <div className="flex justify-end pt-4">
                            <button
                                type="submit"
                                disabled={loading}
                                className="px-8 py-3 bg-gradient-to-r from-teal-600 to-cyan-600 text-white font-bold rounded-xl hover:shadow-lg hover:shadow-teal-500/25 transition-all flex items-center gap-2 disabled:opacity-50"
                            >
                ...
                <div className="fixed inset-0 z-[70] flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm">
                    <div className="bg-[#1e2235] w-full max-w-lg rounded-xl border border-white/10 p-6 animate-fadeInUp">
                        ...
                        <textarea
                            ...
                            className="w-full bg-[#1a1d29] border border-gray-700 rounded-lg p-3 text-white focus:border-teal-500 outline-none min-h-[100px]"
                ...
                <div className="fixed inset-0 z-[70] flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm">
                    <div className="bg-[#1e2235] w-full max-w-2xl rounded-xl border border-white/10 flex flex-col max-h-[85vh]">
                        <div className="p-4 border-b border-white/10 flex justify-between">
                            <h3 className="text-white font-bold">Buscar Artículo</h3>
                            ...
                            {articles.map(a => (
                                <div key={a.codigo_articulo} onClick={() => { addItem(a); setShowArticulosModal(false); }} className="p-3 bg-white/5 hover:bg-white/10 cursor-pointer rounded text-white flex justify-between items-center group">
                                    ...
                                    <div className="text-right">
                                        <div className="text-teal-400 font-bold">{a.cantidad_disponible} UND</div>
