                        ...
                        <div className="bg-white/5 border border-white/10 rounded-xl p-4 md:p-6 mb-8">
                                ...
                                <div>
                                    ...
                                    <div className="relative group">
                                        ...
                                        >
                                            ...
                                            <User className={`w-5 h-5 text-teal-400/50 ml-2`} />
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div>
                                    ...
                                    <div className="relative group">
                                        ...
                                        >
                                            ...
                                            <User className={`w-5 h-5 text-teal-400 ml-2`} />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <textarea
                                    ...
                                    className="w-full bg-white/5 border border-white/10 rounded-xl p-4 text-white focus:border-teal-500 outline-none min-h-[120px] transition-all focus:ring-1 focus:ring-teal-500/50 shadow-inner"
                                    placeholder="Detalles adicionales sobre este pedido de limpieza..."
                                />
                            </div>
                        </div>
