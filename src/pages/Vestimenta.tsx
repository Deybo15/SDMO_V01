                    ...
                    <form onSubmit={handleSubmit} className="p-8">
                                ...
                                <div>
                                    ...
                                    <div className="relative">
                                        <select
                                            ...
                                            className="w-full bg-white/5 border border-white/10 rounded-lg py-3 pl-4 pr-12 text-white focus:border-indigo-400 focus:outline-none appearance-none"
                                            required
                                        >
                                        ...
                                        <button
                                            ...
                                            className="absolute right-0 top-0 bottom-0 px-4 bg-indigo-500/10 hover:bg-indigo-500/20 text-indigo-400 rounded-r-lg border-l border-white/10"
                                        >
                        ...
                        <div className="flex justify-end pt-4">
                            <button
                                type="submit"
                                disabled={loading}
                                className="px-8 py-3 bg-gradient-to-r from-indigo-600 to-blue-600 text-white font-bold rounded-xl hover:shadow-lg hover:shadow-indigo-500/25 transition-all flex items-center gap-2 disabled:opacity-50"
                            >
                ...
                <div className="fixed inset-0 z-[70] flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm">
                    <div className="bg-[#1e2235] w-full max-w-lg rounded-xl border border-white/10 p-6 animate-fadeInUp">
                        ...
                        <textarea
                            ...
                            className="w-full bg-[#1a1d29] border border-gray-700 rounded-lg p-3 text-white focus:border-indigo-500 outline-none min-h-[100px]"
                            ...
                            {articles.map(a => (
                                <div key={a.codigo_articulo} onClick={() => { addItem(a); setShowArticulosModal(false); }} className="p-3 bg-white/5 hover:bg-white/10 cursor-pointer rounded text-white flex justify-between items-center group">
                                    ...
                                    <div className="text-right">
                                        <div className="text-indigo-400 font-bold">{a.cantidad_disponible} UND</div>
