            ...
            <div className="max-w-7xl mx-auto px-8 pb-12 animate-fade-in-up">
                <div className="flex gap-4 mb-8">
                    <button
                        ...
                        className={cn(
                            "flex-1 py-4 px-6 rounded-[8px] border transition-all flex items-center justify-center gap-3",
                            activeTab === 'entrada'
                ...
                <div className="bg-[#121212] rounded-[8px] border border-[#333333] overflow-hidden shadow-2xl p-6">
                    {activeTab === 'entrada' ? (
                        <form onSubmit={confirmSubmitEntrada} className="space-y-8">
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="bg-[#000000]/30 rounded-[8px] border border-[#333333] overflow-hidden">
