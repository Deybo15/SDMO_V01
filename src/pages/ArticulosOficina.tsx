...
export default function ArticulosOficina() {
    return (
        <GenericRequestModule
            ...
            subtitle="Solicitud de Artículos"
            description="Detalle los artículos de oficina requeridos"
            icon={Paperclip}
            colorTheme="pink"
            searchKeywords={['oficina', 'artículos de oficina']}
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                            ...
                            <div className="space-y-2">
                                ...
                                <select
                                    ...
                                    className="w-full bg-slate-900/50 border border-slate-700 rounded-xl px-4 py-3 text-slate-100 focus:outline-none focus:ring-2 focus:ring-pink-500/50 focus:border-pink-500 transition-all"
                                >
