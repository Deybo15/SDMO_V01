                        ...
                        <div className="bg-white/5 border border-white/10 rounded-xl p-4 md:p-6 mb-8">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                                <div>
                                    ...
                                    <div className="relative group">
                                        ...
                                        >
                                            <span className={autoriza ? 'text-pink-400 font-bold' : 'text-gray-500 italic'}>
                                            ...
                                            <User className={`w-5 h-5 text-pink-400/50 ml-2`} />
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div>
                                    ...
                                    <div className="relative group">
                                        ...
                                        >
                                            ...
                                            <User className={`w-5 h-5 text-pink-400 ml-2`} />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <textarea
                                    ...
                                    className="w-full bg-white/5 border border-white/10 rounded-xl p-4 text-white focus:border-pink-500 outline-none min-h-[120px] transition-all focus:ring-1 focus:ring-pink-500/50 shadow-inner"
                                    placeholder="Detalles adicionales sobre este pedido de oficina..."
                                />
                            </div>
                        </div>
