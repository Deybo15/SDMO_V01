...
export default function SinAsignacion() {
    ...
    // Theme (Slate for Unassigned)
    const colorTheme = 'slate';
                ...
                <div className="bg-[#1e2235] border border-white/10 rounded-2xl shadow-xl overflow-hidden">
                    <form onSubmit={handleProcess} className="p-4 md:p-8">
                        ...
                        <div className="bg-white/5 border border-white/10 rounded-xl p-4 md:p-6 mb-8">
                            <h3 className="text-lg font-semibold mb-6 flex items-center gap-2 border-b border-white/10 pb-3 text-slate-400">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                                <div>
                                    ...
                                    <div className="relative group">
                                        ...
                                        >
                                            <span className={autoriza ? 'text-slate-400 font-bold' : 'text-gray-500 italic'}>
                                            ...
                                            <User className={`w-5 h-5 text-slate-400/50 ml-2`} />
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div>
                                ...
                                <textarea
                                    ...
                                    className="w-full bg-white/5 border border-white/10 rounded-xl p-4 text-white focus:border-slate-500 outline-none min-h-[120px] transition-all focus:ring-1 focus:ring-slate-500/50 shadow-inner"
