...
export default function SinAsignacion() {
    return (
        <GenericRequestModule
            ...
            subtitle="Solicitud General"
            description="Para solicitudes que no encajan en otras categorías"
            icon={HelpCircle}
            colorTheme="gray"
            searchKeywords={['sin asignación', 'sin asignacion']}
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                            ...
                            <div className="space-y-2">
                                ...
                                <select
                                    ...
                                    className="w-full bg-slate-900/50 border border-slate-700 rounded-xl px-4 py-3 text-slate-100 focus:outline-none focus:ring-2 focus:ring-gray-500/50 focus:border-gray-500 transition-all"
                                >
